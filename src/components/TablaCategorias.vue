            ...
            >
              <template v-slot:top>
                <v-toolbar
                  flat
                >
                  <v-toolbar-title>Listado Categorias</v-toolbar-title>
                  <v-divider
                    class="mx-4"
                    inset
                    vertical
                  ...
                  <v-dialog v-model="dialogDelete" max-width="500px">
                    <v-card>
                      <v-card-title class="headline">Estas seguro que decea cambiar el estado de la categoria?</v-card-title>
                      <v-card-actions>
                        <v-spacer></v-spacer>
...
export default {
  ...
  computed: {
    formTitle () {
      return this.editedIndex === -1 ? 'Nueva Categoria' : 'Edit Item'
    },
  },
